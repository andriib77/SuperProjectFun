...
public class CargoAircraft extends Aircraft {
    ...
    public CargoAircraft(TypeOfAircraft typeOfAircraft, String model, String owner_AirLine,
        ...
        super(typeOfAircraft, model, owner_AirLine, cargoLengthSM, cargoWidthSM,
                cargoHeightSM, maxRangeWithLoadKM, cruiseSpeedKM, maxTakeoffWeightKG,
                maxPayloadKG, maxFuelWeightKG, fuelConsumptionPerHourKG, passengerCapacityPlaces, crewTeam);
    }
