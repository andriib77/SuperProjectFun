...
public class AirLinesOfAirport {
    ...
    AirLine SunExpress_Germany = new AirLine("SXD", "SunExpress_Germany",
            ...
            10, TypeOfFlights.CHARTER_PASSENGER_FLIGHT);
    ...
    AirLine Lufthansa_Cargo = new AirLine("GEC", "Lufthansa_Cargo", "Germany",
            ...
            50, TypeOfFlights.CHARTER_CARGO_FLIGHT);
    ...
    public static void main(String[] args) {
        ...
        TypeOfFlights typeOfFlights = TypeOfFlights.LETTER_FLIGHT;
      ...
      /*  // Sort by Type of AirCraft
        ...
        TypeOfAircraft sortingByTypeOfAirCraft = TypeOfAircraft.CARGO;
        List<AirLine> sortedAirlinesByTypeOfAirCraft = airLinesOfAirport.SortedAirlinesByTypeOfAirCraft(sortingByTypeOfAirCraft);
        if (sortedAirlinesByTypeOfAirCraft != null) {
            System.out.println("Airlines with type of AirCraft : " + sortingByTypeOfAirCraft);
            for (AirLine airLine : sortedAirlinesByTypeOfAirCraft) {
                System.out.println(airLine.getNameOfAirLine());
                System.out.println("---- ----- -----");
            }
        } else {
        ...
        String typeOfAirLine = "International";
        ...
        ServiceOfAirLine sortingByService = ServiceOfAirLine.CARGO_SERVICE;
